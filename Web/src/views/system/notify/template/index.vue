<template>
        ...
        <el-col :span="8">
          <el-form-item :label="t('system.notify.templateName')" prop="name">
            <el-input
              ...
              :placeholder="t('system.notify.templateNamePlaceholder')"
              clearable
        ...
        <el-col :span="8">
          <el-form-item :label="t('system.notify.status')" prop="status">
            <el-select
              ...
              :placeholder="t('system.notify.statusPlaceholder')"
              clearable
              class="!w-240px"
            >
              <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :table-layout="'auto'" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column
        :label="t('system.notify.templateCode2')"
        align="center"
        prop="code"
        width="120"
      ...
      />
      <el-table-column
        :label="t('system.notify.templateName')"
        align="center"
        prop="name"
        width="120"
        :show-overflow-tooltip="true"
      />
      <el-table-column :label="t('system.notify.type')" align="center" prop="type">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.SYSTEM_NOTIFY_TEMPLATE_TYPE" :value="scope.row.type" />
        </template>
      </el-table-column>
      <el-table-column :label="t('system.notify.nickname')" align="center" prop="nickname" />
      <el-table-column
        ...
        :show-overflow-tooltip="true"
      />
      <el-table-column :label="t('system.notify.status')" align="center" prop="status" min-width="80">
        <template #default="scope">
