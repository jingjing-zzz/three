<template>
    ...
    >
      ...
      <el-form-item label="" prop="category" :style="{ position: 'absolute', right: '300px' }">
        <el-select
          ...
          :placeholder="t('process.task.selectProcessCategory')"
          clearable
          class="!w-155px"
          @change="handleQuery"
        >
      ...
      <el-form-item label="" prop="status" :style="{ position: 'absolute', right: '130px' }">
        <el-select
          ...
          :placeholder="t('process.task.selectApprovalStatus')"
          clearable
          class="!w-155px"
          @change="handleQuery"
        >
      ...
      <el-form-item :style="{ position: 'absolute', right: '0px' }">
        ...
        >
          ...
          <el-form-item class="bold-label" label-position="top">
            <el-button @click="handleQuery">{{ t('common.ok') }}</el-button>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :table-layout="'auto'">
      ...
      <el-table-column
        align="center"
        :label="t('process.task.processId')"
