  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true" :table-layout="'auto'">
      <el-table-column
        ...
        min-width="180"
      />
      <el-table-column align="center" :label="t('followUp.creatorName')" prop="creatorName" />
      <el-table-column align="center" :label="t('followUp.type')" prop="type">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.CRM_FOLLOW_UP_TYPE" :value="scope.row.type" />
        </template>
      </el-table-column>
      <el-table-column align="center" :label="t('followUp.content')" prop="content" />
      <el-table-column :label="t('common.image')" align="center">
        <template #default="scope">
      ...
      <el-table-column :label="t('followUp.files')" align="center">
        <template #default="scope">
      ...
      <el-table-column
        :formatter="dateFormatter"
        align="center"
        :label="t('followUp.contactNextTime')"
        prop="nextTime"
        min-width="180"
      />
      <el-table-column
        align="center"
        :label="t('followUp.contactIds')"
        prop="contactIds"
