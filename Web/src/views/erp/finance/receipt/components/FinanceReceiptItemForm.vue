<template>
  <el-form
    ...
    :disabled="disabled"
  >
    <el-table :data="formData" show-summary :summary-method="getSummaries" class="-mt-10px" :table-layout="'auto'">
      <el-table-column :label="t('index')" type="index" align="center" width="60" />
      <el-table-column :label="t('bizNo')" min-width="200">
      ...
      <el-table-column :label="t('receivableAmount')" prop="totalPrice" fixed="right" min-width="100">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
      ...
      <el-table-column :label="t('receivedAmount')" prop="receiptedPrice" fixed="right" min-width="100">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
      ...
      <el-table-column :label="t('currentReceipt')" prop="receiptPrice" fixed="right" min-width="115">
      ...
      <el-table-column :label="t('remark')" min-width="150">
        <template #default="{ row, $index }">
          <el-form-item :prop="`${$index}.remark`" class="mb-0px!">
            <el-input v-model="row.remark" :placeholder="t('remarkPlaceholder')" />
          </el-form-item>
        </template>
      </el-table-column>
  ...
  <el-row justify="center" class="mt-3" v-if="!disabled">
    <el-button @click="handleOpenSaleOut" round>+ {{ t('addSaleOut') }}</el-button>
    <el-button @click="handleOpenSaleReturn" round>+ {{ t('addSaleReturn') }}</el-button>
  </el-row>
...
const handleOpenSaleOut = () => {
  if (!props.customerId) {
    message.error(t('selectCustomerFirst'))
    return
  }
