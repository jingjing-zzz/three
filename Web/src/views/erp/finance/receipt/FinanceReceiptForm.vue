  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1080">
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('receiptTime')" prop="receiptTime">
            <el-date-picker
              v-model="formData.receiptTime"
              type="date"
              value-format="x"
              :placeholder="t('selectReceiptTime')"
              class="!w-1/1"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('receiptAccount')" prop="accountId">
            <el-select
        ...
        <el-col :span="12">
          <el-form-item :label="t('totalReceipt')" prop="totalPrice">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('actualReceipt')">
            <el-input
              disabled
...
const { t } = useI18n('erp.finance.receipt') // 国际化
...
const formRules = reactive({
  customerId: [{ required: true, message: t('customerRequired'), trigger: 'blur' }],
  receiptTime: [{ required: true, message: t('receiptTimeRequired'), trigger: 'blur' }]
})
