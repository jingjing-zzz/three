...
public interface ErrorCodeConstants {
    ...
    // ========== 工单管理 1_020_015_000 ==========
    ErrorCode WORK_ORDER_NOT_EXISTS = new ErrorCode(1_020_015_000, "工单不存在");
    ErrorCode WORK_ORDER_STATUS_TRANSITION_FAIL = new ErrorCode(1_020_015_001, "工单状态流转失败");
    ErrorCode WORK_ORDER_COMPLETED_CANNOT_UPDATE = new ErrorCode(1_020_015_002, "已完结工单不能修改");
    ErrorCode WORK_ORDER_REJECTED_CANNOT_TRANSITION = new ErrorCode(1_020_015_003, "已退回工单只能重新发起");
