...
-- ==================== OA 出差申请表 ====================
DROP TABLE IF EXISTS `bpm_oa_business_trip`;
CREATE TABLE `bpm_oa_business_trip`  (
...
-- ==================== OA 借款申请表 ====================
DROP TABLE IF EXISTS `bpm_oa_loan`;
CREATE TABLE `bpm_oa_loan`  (
...
-- ==================== OA 客户拜访申请表 ====================
DROP TABLE IF EXISTS `bpm_oa_customer_visit`;
CREATE TABLE `bpm_oa_customer_visit`  (
...
-- ==================== OA 工作报告表 ====================
DROP TABLE IF EXISTS `bpm_oa_work_report`;
CREATE TABLE `bpm_oa_work_report`  (
...
-- ==================== OA 任务管理表 ====================
DROP TABLE IF EXISTS `bpm_oa_task`;
CREATE TABLE `bpm_oa_task`  (
...
-- ==================== OA 日程管理表 ====================
DROP TABLE IF EXISTS `bpm_oa_schedule`;
CREATE TABLE `bpm_oa_schedule`  (
...
-- ==================== OA 请示审批表 ====================
DROP TABLE IF EXISTS `bpm_oa_work_request`;
CREATE TABLE `bpm_oa_work_request`  (
