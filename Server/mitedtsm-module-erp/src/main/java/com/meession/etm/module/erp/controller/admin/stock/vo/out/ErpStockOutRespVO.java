package com.meession.etm.module.erp.controller.admin.stock.vo.out;
...
import static com.meession.etm.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "出库单号", requiredMode = Schema.RequiredMode.REQUIRED, example = "CK001")
    @ExcelProperty("出库单号")
    private String no;
    ...
    @Schema(description = "附件 URL", example = "xxx")
