package com.meession.etm.module.system.service.dept;
...
import com.meession.etm.module.system.controller.admin.dept.vo.dept.DeptSaveReqVO;
import com.meession.etm.module.system.dal.dataobject.dept.DeptDO;
import com.meession.etm.module.system.dal.mysql.dept.DeptMapper;
import com.meession.etm.module.system.dal.redis.RedisKeyConstants;
...
public class DeptServiceImpl implements DeptService {
    ...
    @Override
    @CacheEvict(cacheNames = RedisKeyConstants.DEPT_CHILDREN_ID_LIST, allEntries = true) // allEntries
                                                                                         // 清空所有缓存，因为操作一个部门，涉及到多个缓存
