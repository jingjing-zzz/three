...
public interface DictTypeConstants {
    ...
    // ========== WORK ORDER 模块 ==========
    String WORK_ORDER_TYPE = "system_work_order_type"; // 工单类型
    String WORK_ORDER_PRIORITY = "system_work_order_priority"; // 工单优先级
    String WORK_ORDER_STATUS = "system_work_order_status"; // 工单状态
