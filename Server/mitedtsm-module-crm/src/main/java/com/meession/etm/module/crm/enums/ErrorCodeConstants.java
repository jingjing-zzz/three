...
public interface ErrorCodeConstants {
    ...
    // ========== 商机报价 1_020_002_100 ==========
    ErrorCode BUSINESS_QUOTATION_NOT_EXISTS = new ErrorCode(1_020_002_100, "商机报价不存在");
    ErrorCode BUSINESS_QUOTATION_DRAFT_FAIL_NO_PRODUCT = new ErrorCode(1_020_002_101, "报价草稿失败，原因：没有产品");
    ErrorCode BUSINESS_QUOTATION_CONFIRM_FAIL_STATUS = new ErrorCode(1_020_002_102, "确认报价失败，原因：状态不允许");
    ErrorCode BUSINESS_QUOTATION_CONFIRM_FAIL_BUSINESS_END = new ErrorCode(1_020_002_103, "确认报价失败，原因：商机已结束");
    ErrorCode BUSINESS_QUOTATION_CONFIRM_FAIL_NO_PRODUCT = new ErrorCode(1_020_002_104, "确认报价失败，原因：没有产品");
    ErrorCode BUSINESS_QUOTATION_CONFIRM_FAIL_PRODUCT_COUNT = new ErrorCode(1_020_002_105, "确认报价失败，原因：产品数量无效");
    ErrorCode BUSINESS_QUOTATION_CONFIRM_FAIL_PRODUCT_PRICE = new ErrorCode(1_020_002_106, "确认报价失败，原因：产品价格无效");
    ...
    ErrorCode MARKETING_SMS_BATCH_CANNOT_SEND = new ErrorCode(1_020_016_001, "短信批次状态不允许发送，只有待发送状态才能发送");
    ErrorCode MARKETING_EMAIL_BATCH_CANNOT_SEND = new ErrorCode(1_020_017_001, "邮件批次状态不允许发送，只有待发送状态才能发送");
