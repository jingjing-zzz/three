...
public interface ErrorCodeConstants {
    ...
    ErrorCode ORDER_STATUS_CANNOT_APPROVE = new ErrorCode(1_020_015_002, "订单当前状态不允许审批");
    ErrorCode ORDER_STATUS_TRANSITION_INVALID = new ErrorCode(1_020_015_003, "订单状态流转无效");
