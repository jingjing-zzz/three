...
public class CrmContractServiceImpl implements CrmContractService {
    ...
    public Map<String, Object> getContractStatistics() {
        ...
        Long pendingAuditCount = contractMapper.selectCount(CrmContractDO::getAuditStatus, CrmAuditStatusEnum.PROCESS.getStatus());
        statistics.put("pendingAuditCount", pendingAuditCount);
        Long approvedCount = contractMapper.selectCount(CrmContractDO::getAuditStatus, CrmAuditStatusEnum.APPROVE.getStatus());
